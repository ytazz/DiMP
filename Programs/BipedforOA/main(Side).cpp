...
public:
	...
	virtual void BuildScene(){
		...
		// 中間制約
		biped->waypoints[3].k = 4;
		biped->waypoints[3].fix_pos_com = false;
		biped->waypoints[3].fix_vel_com = false;

		// 中間制約
		biped->waypoints[4].k = 6;
		biped->waypoints[4].fix_pos_com = false;
		...
		// 初期制約				
		 biped->waypoints[0].pos_com = vec2_t(0.0, (walkingPhase == 0 ? -1.0 :  1.0) * 0.03);
